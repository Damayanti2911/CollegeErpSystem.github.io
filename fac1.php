...
.background-radial-gradient {
	...
	<body>
		...
		<section class="background-radial-gradient overflow-hidden">
            ...
            echo "<center><p> <font color=white><h1>Welcome $name1 Ma'am</h1></center><hr><br>";
			echo "<center><p> <font color=white><h3>Faculty ID: $faculty_id</h3></center>";
			echo "<center><p> <font color=white><h3>Branch: $branch1</h3></center>";
			echo "<center><p> <font color=white><h3>Class: $class1</h3></center>";
			echo "<center><p> <font color=white><h3>Subject: $subject1</h3></center>";
			?>
